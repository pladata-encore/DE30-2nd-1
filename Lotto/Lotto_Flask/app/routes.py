...
def predict():
    if request.method == 'POST':
        try:
            model_rnn = pickle.load(open('app/models/pkl/model_RNN.pkl', 'rb'))
            rnn_prediction = model_rnn.predict()

            model_mlp = pickle.load(open('app/models/pkl/model_MLP.pkl', 'rb'))
            mlp_prediction = model_mlp.predict()

            model_rf = pickle.load(open('app/models/pkl/model_RANDOMFOREST.pkl', 'rb'))
            rf_prediction = model_rf.predict()

            model_trans = pickle.load(open('app/models/pkl/model_TRANSFORMER.pkl', 'rb'))
            trans_prediction = model_trans.predict()

            model_cnn = pickle.load(open('app/models/pkl/model_CNN.pkl', 'rb'))
